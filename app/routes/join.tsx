...
import { getUserId, createUserSession, requireUser } from "~/session.server";
...
export const action: ActionFunction = async ({ request }) => {
  ...
  const exisitingPhone = await getUserByPhone(phone);
  if (exisitingPhone) {
    return json<ActionData>(
      { errors: { phone: "A user already exists with this phone number" } },
      { status: 400 }
    );
  }
              ...
              <div className="mt-1">
                <div className="flex w-full items-center space-x-3">
                  ...
                  <input
                    ...
                    aria-describedby="email-error"
                    className="w-full rounded border border-gray-500 px-2 py-1 text-lg placeholder:text-gray-400"
