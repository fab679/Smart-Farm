...
import { verifyFarmLogin, verifyLogin } from "~/models/user.server";
...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  if (userId) return redirect("/farm");
  return json({});
};
...
export const action: ActionFunction = async ({ request }) => {
  ...
  const user = await verifyFarmLogin(email, password);
  ...
  return createFarmSession({
    ...
    redirectTo: typeof redirectTo === "string" ? redirectTo : "/farm",
  });
};
...
export default function LoginFarmPage() {
