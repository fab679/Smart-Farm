...
import { getcompletedFarmOrders } from "~/models/farm.server";
import { getFarmId } from "~/session.server";

interface LoaderData {
  orders: Awaited<ReturnType<typeof getcompletedFarmOrders>>;
}
...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  return json<LoaderData>(
    {
      orders: await getcompletedFarmOrders(farmId),
    },
    {
      status: 200,
    }
